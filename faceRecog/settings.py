...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Remove when running as a local host
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Remove when running as a local host
